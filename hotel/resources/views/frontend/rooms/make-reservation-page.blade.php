    ...
    <div>
        <div class="container">
            ...
            <form action="{{ route('frontend.payment.store', ['room' => $room]) }}" method="post" role="form">
                ...
                @endif
                <h1 class="rooms-section-title">Make your reservation</h1>
                <div class="booking-page-container">
                    <div class="personal-information">
                        ...
                        <div class="display-grid full-input">
                            <label class="reservation-form-label">Company Names <span style="text-transform:lowercase">(only
                                    if the reservation is made from
                                    the company's bank account)</span></label>
                        ...
                        <div class="display-grid full-input">
                            <label class="reservation-form-label">City</label>
                        ...
                        <div>
                            <div class="booking-info">
                                ...
                                <input autocomplete="off" type="date" name="check_in" id="check_in"
                                    class="reservation-form-input"
                                    value="{{ request()->input('check_in', date('Y-m-d')) }}" min="{{ date('Y-m-d') }}"
                                    readonly>
                            </div>
                            <div class="booking-info">
                            ...
                            <table class="reservation-page-table">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-rightside"><span class="table_total_price"
                ...
                <div class="payment-card">
                    <div class="payment-box">
                        <div class="payment-method">
                            <p>
                                <input type="radio" checked id="cash-on-delivery" name="payment_method"
                                    value="cash">
                            ...
                            <div id="stripe_pay" class="stripe-card" style="display: none;">
                                ...
                                <div>
                                    ...
                                    <div class="card-number-data">
                                        <input autocomplete="off" class="card-number-data-input card-number"
                                            maxlength="4" pattern="[0-9]*" inputmode="numeric" placeholder="xxxx"
                                ...
                                <div class="exp-wrapper">
                                    <input autocomplete="off" class="exp" id="month" maxlength="2"
                                        pattern="[0-9]*" inputmode="numeric" placeholder="MM" type="text"
                                        data-pattern-validate />
                                    <input autocomplete="off" class="exp" id="year" maxlength="2"
                                        pattern="[0-9]*" inputmode="numeric" placeholder="YY" type="text"
                                        data-pattern-validate />
                                </div>
                            </div>
                        </div>
            ...
            <script>
                ...
                const validateExpirationDate = function() {
                    ...
                    if (inputYear < currentYear || (inputYear === currentYear && inputMonth < new Date().getMonth() + 1)) {
                        monthInput.setCustomValidity('Expiration date is in the past');
                    } else {
