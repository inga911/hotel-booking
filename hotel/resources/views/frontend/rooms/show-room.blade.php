...
@section('content')
    ...
    <div class="show-room-card">
        <div class="check-in-out">
            <div class="booking-page-check">
                <div>
                    <h2>Check availability of this room</h2>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-rightside"><span
                                                    class="table_price_per_night">{{ $room->price }}</span> <i
            ...
            @if (count($room->gallery) > 0)
                <div class="photo-gallery booking-page-gallery">
    ...
    <div class="room-info">
        ...
        <a href="{{ route('frontend.reservation', $room) }}">BOOK NOW</a>
    </div>
    </div>
